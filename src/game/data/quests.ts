...
export const QUEST_CHAINS: ChainDef[] = [
  ...
  },
  {
    ...
    rewardRenown: 2,
    title: 'Tally-Breaker',
    epilogue: 'The general kept records. Names, dates, places, tallied like inventory. One word appears in the margins more than any other, in a hand that is not the general\'s own: the Harrower. Nobody at the Keep has heard the name before. Everybody has started asking around anyway.',
    stages: [
  ...
  },
  {
    ...
    stages: [
      ...
      { name: 'The Road to Saint Aurlias Rest', flavour: 'An old war-cleric built a church there once, long before anyone needed protecting from what sleeps under it now.', difficulty: 'epic', duration: 16 * HOUR, goldMultiplier: 2.9 },
      { name: 'The Dead of Saint Aurlias', flavour: 'The town moves before the church does. It will not be the last thing that moves tonight.', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 3.1 },
      { name: 'The Rider in the Nave', flavour: 'He does not dismount. He has not needed to in a very long time.', difficulty: 'legendary', duration: 24 * HOUR, goldMultiplier: 4.0 },
    ],
  },
  {
    id: 'dragon_hunt',
