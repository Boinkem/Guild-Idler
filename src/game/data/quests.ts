...
export const QUEST_CHAINS: ChainDef[] = [
  ...
  },
  {
    ...
    stages: [
      { name: 'Smoke Over Thornhollow', flavour: "The demons didn't raze this town -- they went through it door by door, upending drawers and tearing up floorboards, looking for something specific and leaving everything else untouched. That's worse than raiding. Raiding you can understand.", tag: 'explore', difficulty: 'normal', duration: 4 * HOUR, goldMultiplier: 1.4 },
      { name: 'The Trail North', flavour: "A crow lands on the ruined gate as you leave, tilts its head, and doesn't fly off. It hasn't left your shoulder since -- through two towns and a river crossing -- like it knows exactly where this is going and isn't willing to risk you getting there without it.", tag: 'explore', difficulty: 'normal', duration: 5 * HOUR, goldMultiplier: 1.5 },
      { name: "Greywick's Alchemist", flavour: "She's already grinding spider venom before you finish explaining, hands moving faster than her questions. Fresh is the only word that matters here -- the ones who were bitten are still people right now, and every hour past fresh shortens how long that stays true.", tag: 'arcane', difficulty: 'hard', duration: 6 * HOUR, goldMultiplier: 1.7 },
      { name: 'The Road to IronRest', flavour: "Four vials, wrapped in cloth thick enough that you can't feel them shift, carried the way you'd carry something that might still be alive. Every mile closer to IronRest is a mile further from the ones still waiting to find out if this works.", tag: 'defense', difficulty: 'hard', duration: 6 * HOUR, goldMultiplier: 1.8 },
    ],
  },
  {
    id: 'harrowers_foot',
    ...
    stages: [
      { name: 'The Pattern in the Ash', flavour: "Every burned house in this village was searched before it burned, and searched thoroughly -- floorboards pried up, cellars emptied, nothing left to chance. That isn't how raiding works. That's how looking works, and looking means someone is still searching for something they haven't found yet.", tag: 'explore', difficulty: 'normal', duration: 5 * HOUR, goldMultiplier: 1.5 },
      { name: 'What the Foot Soldiers Take', flavour: "These demons don't fight like animals starving for the next kill -- they fight like soldiers being watched, like something is going to ask them afterward exactly what they found and where. Whatever's giving these orders expects a full report.", tag: 'combat', difficulty: 'hard', duration: 7 * HOUR, goldMultiplier: 1.8 },
    ],
  },
  {
    ...
    stages: [
      { name: "The General's Column", flavour: "It marches in formation, ranks holding even across broken ground, and demons do not march. Something taught it to -- drilled it, the same way you'd drill a soldier -- and that should worry you more than teeth ever could.", tag: 'combat', difficulty: 'hard', duration: 9 * HOUR, goldMultiplier: 2.0 },
      { name: 'The Ledger', flavour: "Names, dates, places -- every village it emptied, tallied like inventory in a hand too neat for a demon to have written it. It was already counting the space where your name would go before you ever arrived.", tag: 'stealth', difficulty: 'epic', duration: 12 * HOUR, goldMultiplier: 2.4 },
    ],
  },
  {
    ...
    stages: [
      { name: 'The Empty Graves', flavour: "Every grave here has been dug from beneath, dirt scattered outward in a ring, no tool marks and no footprints leading away -- only footprints leading toward the old barrow-ground east of town, dozens of them, walking in step like they'd all been given the same destination.", tag: 'explore', difficulty: 'hard', duration: 10 * HOUR, goldMultiplier: 2.1 },
      { name: 'The Harvest', flavour: "They remember their own names. They answer to them, even, when you say them out loud -- which is somehow so much worse than if they'd forgotten everything, because it means whatever they are now, they know exactly what they used to be.", tag: 'combat', difficulty: 'epic', duration: 13 * HOUR, goldMultiplier: 2.5 },
      { name: 'Something Older Stirs', flavour: 'The old barrow-ground has sat quiet for three hundred years, moss grown thick over every stone marker. It is not quiet tonight -- something underneath is moving for the first time in three centuries, and it is not moving slowly.', tag: 'combat', difficulty: 'epic', duration: 15 * HOUR, goldMultiplier: 2.7 },
    ],
  },
  {
    ...
    stages: [
      { name: 'Officers of IronRest', flavour: "Captain Thorne doesn't say please, doesn't soften an order, and doesn't repeat herself. She's run this Bastion through worse than one guild's growing pains, and she expects you to keep up without being told twice.", tag: 'defense', difficulty: 'normal', duration: 6 * HOUR, goldMultiplier: 1.6 },
      { name: 'Beasts on the Border', flavour: "Something is thinning the border patrols one soldier at a time, and it isn't raiders -- raiders don't drag their kills forty feet into the treeline and leave the boots behind, still laced.", tag: 'combat', difficulty: 'hard', duration: 8 * HOUR, goldMultiplier: 1.9 },
      { name: 'The Fort in the North-West', flavour: "Thorne's terms are simple: take the fort back from whatever's squatting in it, and the Keep is yours to call home -- so long as IronRest can always call on it when the debt comes due.", tag: 'combat', difficulty: 'epic', duration: 14 * HOUR, goldMultiplier: 2.4 },
      { name: "The Demon Lord's Throne", flavour: "Whatever ruled this fort didn't build a throne room to be comfortable. It built one to be seen from every angle at once, by anyone unlucky enough to be standing in it.", tag: 'combat', difficulty: 'legendary', duration: 20 * HOUR, goldMultiplier: 3.2 },
    ],
  },
  {
    id: 'granite_crossing',
    ...
    stages: [
      { name: 'The Silent Quarry', flavour: "Garrick and his raiders have taken the town gate and dug in like they mean to stay a season. The stonemasons hold everything behind it -- for now, and the longer this drags on, the less certain that for now sounds.", tag: 'combat', difficulty: 'hard', duration: 8 * HOUR, goldMultiplier: 2.0 },
      { name: "Garrick's Reckoning", flavour: "He pitched his camp inside the quarry itself, right in the working pit, like he wanted the masons to watch him do it. Stonemasons remember who does that to their livelihood, and they remember for a very long time.", tag: 'combat', difficulty: 'epic', duration: 12 * HOUR, goldMultiplier: 2.4 },
    ],
  },
  {
    id: 'farm_at_the_edge',
    ...
    stages: [
      { name: 'No Word From the Farm', flavour: "The fields stand untouched, crops still ripening in neat rows -- but the farmhouse is anything but untouched. Raiders have dug in around it like they intend to winter there, not pass through.", tag: 'combat', difficulty: 'hard', duration: 9 * HOUR, goldMultiplier: 2.1 },
      { name: 'What Vayne Was Becoming', flavour: "Captain Vayne is mid-ritual when you find her, something dark being poured into her a measure at a time, paid for with more of herself than she has left to spend. Whatever this was supposed to make her into, it isn't finished yet -- which might be the only reason there's still time to stop it.", tag: 'arcane', difficulty: 'epic', duration: 13 * HOUR, goldMultiplier: 2.5 },
    ],
  },
  {
    id: 'the_pale_rider',
    ...
    stages: [
      { name: "The Ashen Hand's Plea", flavour: "These paladins don't ask for help easily -- years of training see to that. That they're asking at all, standing here in armor that's seen real use, should worry you more than it visibly worries them.", tag: 'defense', difficulty: 'epic', duration: 14 * HOUR, goldMultiplier: 2.6 },
      { name: 'The Road to Saint Aurlias Rest', flavour: "An old war-cleric built a church out here once, long before anyone needed protecting from whatever sleeps beneath it now. Hoofprints mark this road and only this road for eleven straight miles, evenly spaced, never breaking stride.", tag: 'explore', difficulty: 'epic', duration: 16 * HOUR, goldMultiplier: 2.9 },
      { name: 'The Dead of Saint Aurlias', flavour: "These graves emptied from the inside same as every other place the Harrower has passed through -- except here, the dead are walking toward the church, not away from it, drawn like something behind that door is calling them home by name.", tag: 'combat', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 3.1 },
      { name: 'The Rider in the Nave', flavour: "He was waiting behind the doors the dead were so eager to reach, seated and unmoving, and he does not dismount. He hasn't needed to in longer than anyone currently breathing has been alive.", tag: 'combat', difficulty: 'legendary', duration: 24 * HOUR, goldMultiplier: 4.0 },
    ],
  },
  {
    id: 'dragon_hunt',
    ...
    stages: [
      { name: 'Follow the Ash Trail', flavour: 'The ash here is cold, but the scorched ground underneath is still warm to the touch. Whatever did this passed through recently -- recently enough that it might still be close.', tag: 'explore', difficulty: 'hard', duration: 8 * HOUR, goldMultiplier: 1.5 },
      { name: 'Question the Survivors', flavour: 'Every survivor tells the same story with the same wide-eyed disbelief: wings spanning the whole width of the valley, blotting out the sky before the fire even started falling.', tag: 'explore', difficulty: 'normal', duration: 6 * HOUR, goldMultiplier: 1.5 },
      { name: 'Scale the Cinder Pass', flavour: 'The only way up this mountain is the same route the dragon uses to come down -- a narrow, ash-choked pass with no cover and no second path if something goes wrong halfway.', tag: 'explore', difficulty: 'epic', duration: 14 * HOUR, goldMultiplier: 2 },
      { name: 'The Dragon of Emberfell', flavour: "There is no retreat from this ledge, no fallback position, nowhere left to regroup. Bring everything the guild has, because everything is exactly what this is going to take.", tag: 'combat', difficulty: 'legendary', duration: 20 * HOUR, goldMultiplier: 3 },
    ],
  },
  {
    id: 'lost_kingdom',
    ...
    stages: [
      { name: 'Chart the Grey Marches', flavour: 'Six straight days of featureless grey nothing, and then, without warning, a stone road that has no business existing this far from anywhere charted.', tag: 'explore', difficulty: 'normal', duration: 10 * HOUR, goldMultiplier: 1.6 },
      { name: 'Cross the Silent Bridge', flavour: "It holds your weight without so much as a creak, which is somehow the most unsettling part of a bridge that shouldn't still be standing at all.", tag: 'explore', difficulty: 'hard', duration: 12 * HOUR, goldMultiplier: 1.8 },
      { name: 'Open the Sunken Vault', flavour: "Whatever this lost kingdom locked away down here, they locked it away thoroughly -- layers of stone, then steel, then something that isn't quite either, all sealed around whatever waits at the center.", tag: 'arcane', difficulty: 'epic', duration: 16 * HOUR, goldMultiplier: 2.4 },
    ],
  },
  {
    id: 'demon_fortress',
    ...
    stages: [
      { name: 'Break the Outer Siege', flavour: "Ladders against the wall, fire in the ditch, and a night that refuses to end fast enough. This is the easy part, and it still costs plenty.", tag: 'combat', difficulty: 'hard', duration: 10 * HOUR, goldMultiplier: 2 },
      { name: 'Break the Warding Choir', flavour: "Nine years unbroken and thick enough to hold a whole fortress shut from the inside -- you're not here to silence it for good, just to make it stop mattering long enough to get past the gate it's guarding.", tag: 'arcane', difficulty: 'epic', duration: 14 * HOUR, goldMultiplier: 2.4 },
      { name: 'The Iron Gate', flavour: "Whatever holds this gate remembers the last siege in detail, and it's had years to plan for the next one.", tag: 'combat', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 2.6 },
      { name: 'Descend to the Throne', flavour: "One door left between the guild and whatever's been ruling behind it. It's already standing open, which is somehow worse than finding it locked.", tag: 'combat', difficulty: 'legendary', duration: 24 * HOUR, goldMultiplier: 3.5 },
    ],
  },
  {
    id: 'ancient_crown',
    ...
    stages: [
      { name: 'The Fragment in the Fen', flavour: 'Cold water to the knees, colder mud underneath, and something patient enough to have been guarding this fragment since long before the fen had a name.', tag: 'explore', difficulty: 'normal', duration: 8 * HOUR, goldMultiplier: 1.5 },
      { name: 'The Fragment in the Vault', flavour: "The banker insists, with a completely straight face, that it's just a paperweight -- which is exactly the kind of thing someone says about an object they know is worth killing over.", tag: 'stealth', difficulty: 'hard', duration: 10 * HOUR, goldMultiplier: 1.8 },
      { name: 'The Fragment in the Fire', flavour: 'Last reported seen inside an active forge, sitting in coals hot enough to melt steel. Of course it was.', tag: 'explore', difficulty: 'epic', duration: 12 * HOUR, goldMultiplier: 2.2 },
    ],
  },
  {
    id: 'goblin_warband',
    ...
    stages: [
      { name: 'Scatter the Outriders', flavour: "The outriders always give themselves away -- mismatched armor clattering, torches lit hours before dark, laughing about a raid that hasn't happened yet. Cut them down before they reach camp, and the warband rides in blind.", tag: 'combat', difficulty: 'normal', duration: 3 * HOUR, goldMultiplier: 1.3 },
      { name: "The Chieftain's Camp", flavour: "The chieftain holds court under three crowns stacked crooked on a head too small for any of them -- trophies, not treasures, each one looted off someone who mattered more than he ever will. He's convinced the wearing makes him a king. He's about to learn exactly how wrong that is, right before the horde scatters without him.", tag: 'combat', difficulty: 'hard', duration: 5 * HOUR, goldMultiplier: 1.6 },
    ],
  },
  {
    id: 'third_crown',
    ...
    stages: [
      { name: 'The Toll That Should Not Exist', flavour: "A gate has gone up on the Blackford road again, manned by men who were farming their own fields a season ago and now answer to someone who very much wasn't a farmer.", tag: 'combat', difficulty: 'normal', duration: 3 * HOUR, goldMultiplier: 1.3 },
      { name: 'What the Crown Left Behind', flavour: "The old toll house still keeps records, and one name in them belongs to a lord who lost absolutely everything the same season the goblin king acquired his third crown. He was reported dead. He wasn't -- and whoever's keeping these records knows it too.", tag: 'explore', difficulty: 'normal', duration: 4 * HOUR, goldMultiplier: 1.5 },
      { name: 'The Company He Kept', flavour: "Eighty men standing in real ranks, a granary stocked with grain it never grew itself, and a chain of command running two officers deep. A dispossessed lord doesn't build an operation like this alone, and he clearly isn't planning on staying dispossessed much longer.", tag: 'combat', difficulty: 'hard', duration: 5 * HOUR, goldMultiplier: 1.8 },
    ],
  },
  {
    id: 'hollow_choir',
    ...
    stages: [
      { name: 'Follow the Hymn', flavour: "It carries for miles and never repeats a single verse, and you've heard the shape of this before -- not the melody, but the wards woven underneath it. Whatever escaped that fortress has found itself a new home in these cathedral walls. Not for much longer.", tag: 'explore', difficulty: 'hard', duration: 10 * HOUR, goldMultiplier: 1.8 },
      { name: 'The Choir Loft', flavour: "No singers up in the loft -- just one thing, fused into the rafters in wet coils of flesh, dozens of mouths opening and closing in careful sequence so the note never once has to stop. It sings beautifully. That's somehow the most disturbing part of all of it.", tag: 'combat', difficulty: 'epic', duration: 14 * HOUR, goldMultiplier: 2.2 },
      { name: 'Silence the Chord', flavour: "Whatever this thing has been building toward this whole time, it's nearly finished -- and finished is very much not what the guild came here to let it be.", tag: 'arcane', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 2.6 },
    ],
  },
  {
    id: 'world_ender',
    ...
    stages: [
      {
        ...
        tag: 'arcane', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 2.7,
      },
      {
        ...
        flavour:
          ...
          "finish a rite.",
        tag: 'explore', difficulty: 'epic', duration: 20 * HOUR, goldMultiplier: 2.9,
      },
      {
        ...
        tag: 'arcane', difficulty: 'legendary', duration: 22 * HOUR, goldMultiplier: 3.4,
      },
      {
        ...
        tag: 'arcane', difficulty: 'legendary', duration: 24 * HOUR, goldMultiplier: 3.6,
      },
    ],
  },
  {
    ...
    stages: [
      { name: 'The Grave Reopens', flavour: 'The seal held for three hundred years, stone unmoved, wards unbroken. It held for exactly one night less than it needed to.', tag: 'combat', difficulty: 'epic', duration: 18 * HOUR, goldMultiplier: 2.8 },
      { name: 'The Procession of the Dead Court', flavour: 'Every advisor he ever had executed is walking behind him now in perfect procession, and not one of them looks angry about it anymore. That is the part that should worry you.', tag: 'combat', difficulty: 'legendary', duration: 22 * HOUR, goldMultiplier: 3.4 },
      { name: 'The Bridge of Forgotten Oaths', flavour: 'This bridge only bears the weight of those who never once broke a promise in their lives. Cross very, very carefully.', tag: 'arcane', difficulty: 'legendary', duration: 26 * HOUR, goldMultiplier: 3.8 },
      { name: 'The Second Coronation', flavour: "He's nearly home. The crown still remembers the shape of his head, even if the kingdom underneath it has long since forgotten his name.", tag: 'combat', difficulty: 'legendary', duration: 30 * HOUR, goldMultiplier: 4.4 },
    ],
  },
];
