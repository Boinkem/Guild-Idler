...
export declare namespace leaderboard {
   ...
   * rejected promise.
   */
  export function uploadGuildPowerScore(score: number, forceUpdate: boolean): Promise<boolean>
  export const enum GuildPowerScope {
    Global = 0,
    Friends = 1
  }
  export interface GuildPowerEntry {
    /**
  ...
  export function downloadGuildPowerEntries(scope: GuildPowerScope, start: number, end: number): Promise<Array<GuildPowerEntry>>
}
